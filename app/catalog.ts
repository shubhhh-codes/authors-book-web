...
export const catalog: CatalogBook[] = ([
  {
    ...
    shortTitle: "Think Like a Monk",
    author: "Jay Shetty",
    description:
      "Train your mind for peace and purpose every day by drawing on ancient wisdom and Jay Shetty’s rich experiences in the ashram.",
    quote: "When you try to silence your mind, it gets louder. When you observe your mind, it gets calmer.",
    quoteBy: "Jay Shetty",
    format: "Hardcover · 328 pages",
    availability: "Available now",
    url: "https://jayshetty.me/book/",
    cover: "#2b6192",
    accent: "#ffffff",
    ink: "#ffffff",
    motif: "orbit",
    height: 2.25,
    thickness: 0.26,
    coverImage: "/books/think-like-a-monk/cover.jpg",
    living: true,
  },
  {
